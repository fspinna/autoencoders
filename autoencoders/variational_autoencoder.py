...
def build_decoder(
    ...
    decoder_layers = keras.layers.Dense(encoder.layers[-4].output_shape[1])(decoder_layers)
    decoder_layers = keras.layers.Reshape(encoder.layers[-5].output_shape[1:])(decoder_layers)
